...
Vue.component('table-of-contents', __webpack_require__(7));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-02c94559", Component.options)
  } else {
    hotAPI.reload("data-v-02c94559", Component.options)
  }
...
var AnchorJs = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getHeadingText: function getHeadingText(element) {
      var text = '';
  ...
  mounted: function mounted() {
    ...
    anchors.add();
    var getHeadingText = this.getHeadingText;
    this.links = anchors.elements.filter(function (el) {
      return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.includes(['H2', 'H3'], el.tagName);
    }).map(function (el) {
      return {
...
var render = function() {
  ...
  return _vm.links.length > 0
    ? _c(
        "div",
        { staticClass: "max-w-full w-auto mr-6" },
        _vm._l(_vm.links, function(link) {
          return _c(
            "div",
            {
              staticClass: "mb-2 w-auto max-w-full truncate",
              class: link.isChild ? "ml-4" : ""
            },
            [
              _c(
                "a",
                {
                  staticClass:
                    "text-grey-darker px-6 py-1 mb-1 text-sm no-underline hover:text-black focus:text-black truncate",
                  attrs: { title: link.text, href: link.href }
                },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-02c94559", module.exports)
  }
}
